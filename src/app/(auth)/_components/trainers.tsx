   ...
   return (
      <section id="trainers" className="mt-12 mb-6 relative">
         ...
         <div className="container mx-auto p-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8 py-10 place-items-center overflow-hidden">
               {trainers.map((trainer, index) => (
                  <ScrollReveal XorY="y" minusplus={index % 2 === 0 ? '-' : '+'}>
                     <div key={index} className="w-72 mb-2 hover:brightness-110 transition duration-200">
