         ...
         <div className="container mx-auto p-2 flex flex-col">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 justify-center">
               <div className="flex flex-col gap-4">
                  <h1 className="text-base sm:text-xl font-semibold text-[--main-color]">Links</h1>
               ...
               <div className="flex flex-col gap-4">
                  <h1 className="text-base sm:text-xl font-semibold text-[--main-color]">Horários</h1>
                  <ul className="flex flex-col gap-1 sm:gap-2">
                     <li className="flex gap-2">
                        <p className="font-semibold text-[--second-color] text-sm sm:text-base">Seg a sex</p>
                        <p className="text-sm sm:text-base">24 horas</p>
                     </li>
                     <li className="flex gap-2">
                        <p className="font-semibold text-[--second-color] text-sm sm:text-base">Sábado</p>
                        <p className="text-sm sm:text-base">06:00 - 00:00</p>
                     </li>
                     <li className="flex gap-2">
                        <p className="font-semibold text-[--second-color] text-sm sm:text-base">Domingo</p>
                        <p className="text-sm sm:text-base">07:00 - 23:00</p>
                     </li>
                  </ul>
               </div>
               <div className="flex flex-col gap-4">
                  <h1 className="text-base sm:text-xl font-semibold text-[--main-color]">Redes Sociais</h1>
                  <ul className="flex flex-col gap-1 sm:gap-2">
               ...
               <div className="flex flex-col gap-4">
                  <h1 className="text-base sm:text-xl font-semibold text-[--main-color]">Contatos</h1>
                  <ul className="flex flex-col gap-1 sm:gap-2">
                     <li className="flex items-center gap-2">
